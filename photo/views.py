...
from simpleBlog.settings import MEDIA_URL
...
def album(request, pk, view="thumbnails"):
	...
	if not album.public and not request.user.is_authenticated():
		return HttpResponse("Error: you need to be logged in before you can see this album")
	...
	return render_to_response("photo/album.html", dict(album=album, images=images, user=request.user, view=view, media_url=MEDIA_URL))
